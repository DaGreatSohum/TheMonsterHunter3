...
function draw() {
 ...
 fill("darkorange")
 textSize(15)
 text("Press spacebar to shoot monster. Press the mouse over the tank fly and dodge goo from monster. Press 'Stop Flying' to go back on land to shoot the monster",50,70);
